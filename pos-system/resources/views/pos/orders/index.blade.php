        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <div class="relative">
                <input type="text" x-model="searchQuery" @input.debounce.400ms="applyFilters()"
                       ...
                       class="bg-white border border-gray-700 text-gray-700 text-sm rounded-lg pl-9 pr-4 py-2 w-52 focus:ring-brand-500/20 focus:border-brand-500 placeholder-gray-400">
