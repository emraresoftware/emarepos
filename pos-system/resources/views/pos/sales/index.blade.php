    ...
    <div class="shrink-0 border-t border-gray-200 bg-white px-3 pt-3 pb-4 safe-bottom shadow-[0_-6px_20px_rgba(15,23,42,0.06)]">
        <div class="grid grid-cols-3 lg:grid-cols-6 gap-3">
            <button @click="cart.length ? processPayment('cash') : showToast('Önce sepete ürün ekleyin.', 'warning')"
                    class="flex flex-col items-center justify-center gap-2.5 min-h-[96px] rounded-[22px] text-white font-bold text-sm shadow-sm transition-all hover:-translate-y-0.5 hover:brightness-110 hover:shadow-lg active:translate-y-0"
                    style="background: linear-gradient(135deg, #43b692, #39a583);">
                <span class="w-10 h-10 rounded-full bg-white/18 flex items-center justify-center backdrop-blur-sm shadow-inner shadow-white/10">
                    <i class="fas fa-money-bill-wave text-xl leading-none"></i>
                </span>
            ...
            <button @click="cart.length ? processPayment('card') : showToast('Önce sepete ürün ekleyin.', 'warning')"
                ...
                <span class="w-10 h-10 rounded-full bg-white/18 flex items-center justify-center backdrop-blur-sm shadow-inner shadow-white/10">
                    <i class="fas fa-credit-card text-xl leading-none"></i>
                </span>
            ...
            <button @click="cart.length ? (showMixedPayment = true, mixedRemaining = totals.grand_total) : showToast('Önce sepete ürün ekleyin.', 'warning')"
                ...
                <span class="w-10 h-10 rounded-full bg-white/18 flex items-center justify-center backdrop-blur-sm shadow-inner shadow-white/10">
                    <i class="fas fa-layer-group text-xl leading-none"></i>
                </span>
            ...
            <button @click="!cart.length ? showToast('Önce sepete ürün ekleyin.', 'warning') : !selectedCustomer ? showToast('Veresiye için müşteri seçiniz.', 'error') : processPayment('credit')"
                ...
                <span class="w-10 h-10 rounded-full bg-white/18 flex items-center justify-center backdrop-blur-sm shadow-inner shadow-white/10">
                    <i class="fas fa-file-invoice-dollar text-xl leading-none"></i>
                </span>
            ...
            <div class="relative" @click.away="showOtherPayments = false">
                <button @click="cart.length ? showOtherPayments = !showOtherPayments : showToast('Önce sepete ürün ekleyin.', 'warning')"
                        class="w-full h-full flex flex-col items-center justify-center gap-2.5 min-h-[96px] rounded-[22px] text-white font-bold text-sm shadow-sm transition-all hover:-translate-y-0.5 hover:brightness-110 hover:shadow-lg active:translate-y-0"
                        :class="!cart.length ? 'opacity-55' : ''"
                        style="background: linear-gradient(135deg, #3b82f6, #2563eb);">
                    <span class="w-10 h-10 rounded-full bg-white/18 flex items-center justify-center backdrop-blur-sm shadow-inner shadow-white/10">
                        <i class="fas fa-ellipsis-h text-xl leading-none"></i>
                    </span>
            ...
            <button @click="cart.length ? clearCart() : showToast('Sepet zaten boş.', 'warning')"
                ...
                <span class="w-10 h-10 rounded-full bg-white/18 flex items-center justify-center backdrop-blur-sm shadow-inner shadow-white/10">
                    <i class="fas fa-trash text-xl leading-none"></i>
                </span>
        ...
        <div class="grid grid-cols-3 lg:grid-cols-5 gap-3 mt-3">
            <button @click="loadRecentSales()"
                    class="flex flex-col items-center justify-center gap-2 min-h-[88px] rounded-[22px] text-white font-bold text-sm shadow-sm transition-all hover:-translate-y-0.5 hover:brightness-110 hover:shadow-lg active:translate-y-0"
                    style="background: linear-gradient(135deg, #64748b, #475569);">
                <span class="w-10 h-10 rounded-full bg-white/16 flex items-center justify-center backdrop-blur-sm shadow-inner shadow-white/10">
                    <i class="fas fa-receipt text-xl leading-none"></i>
                </span>
            ...
            <button @click="showDiscountModal = true"
                ...
                <span class="w-10 h-10 rounded-full bg-white/16 flex items-center justify-center backdrop-blur-sm shadow-inner shadow-white/10">
                    <i class="fas fa-percent text-xl leading-none"></i>
                </span>
            ...
            <button @click="printReceipt()"
                    ...
                    style="background: linear-gradient(135deg, #64748b, #475569);">
                <span class="w-10 h-10 rounded-full bg-white/16 flex items-center justify-center backdrop-blur-sm shadow-inner shadow-white/10">
                    <i class="fas fa-print text-xl leading-none"></i>
                </span>
            ...
            <button @click="startRefund()"
                ...
                <span class="w-10 h-10 rounded-full bg-white/16 flex items-center justify-center backdrop-blur-sm shadow-inner shadow-white/10">
                    <i class="fas fa-undo text-xl leading-none"></i>
                </span>
            ...
            <button @click="openOdemeAl()"
                ...
                <span class="w-10 h-10 rounded-full bg-white/16 flex items-center justify-center backdrop-blur-sm shadow-inner shadow-white/10">
                    <i class="fas fa-hand-holding-usd text-xl leading-none"></i>
                </span>
